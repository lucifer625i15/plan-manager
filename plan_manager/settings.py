"""
Django settings for plan_manager project.
...
SECRET_KEY = 'django-insecure-_l86eu7+jv#m13siokl53=43s3unmnrr=m&)%^6nh-)k(4xe(e'
...
WSGI_APPLICATION = 'plan_manager.wsgi.application'
